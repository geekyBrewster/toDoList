    ...
    success: function(response){
      ...
      for(var i = 0; i < toDos.length; i++){
        ...
        if(toDo.completed){
          ...
          $el.hide();
          $el.append('<span class="taskText">' + toDo.task + '</span>');
          $el.append('<button class="btn undoBtn" data-id="' + toDo.id +'"><i class="fa fa-undo fa-2x" aria-hidden="true"></i></button>');
          $el.append('<button class="btn deleteBtn" data-id="' + toDo.id + '"><i class="fa fa-trash fa-2x" aria-hidden="true"></i></button>');
          $el.slideDown();
        } else {
          ...
          $el.hide();
          $el.append('<span class="taskText">' + toDo.task + '</span>');
          $el.append('<button class="btn completedBtn" data-id="' + toDo.id +'"><i class="fa fa-check-square fa-2x" aria-hidden="true"></i></button>');
          $el.append('<button class="btn deleteBtn" data-id="' + toDo.id + '"><i class="fa fa-trash fa-2x" aria-hidden="true"></i></button>');
          $el.slideDown();
        }
      } // end of for loop
